...
(function () {
    ...
    // --- Nav items (top nav) ---
    var items = [
        { label: 'Social Engine',      href: 'social.html',      key: 'social' },
        { label: 'Knowledge Engine',  href: 'topics/index.html', key: 'topics' },
        { label: 'Interactive Archive', href: 'ask.html',        key: 'ask' },
